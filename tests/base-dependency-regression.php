...
$checks = [
	...
	'ExtensionRegistry required' => str_contains( $main, 'CB\\Core\\ExtensionRegistry' ),
	'PageRegistry required' => str_contains( $main, 'CB\\Core\\Admin\\PageRegistry' ),
	'public Page contract required' => str_contains( $main, 'CB\\Core\\Admin\\Page' ),
	'IntegrationGrid required' => str_contains( $main, 'CB\\Core\\UI\\IntegrationGrid' ),
	'Icon renderer required' => str_contains( $main, 'CB\\Core\\UI\\Icon' ),
