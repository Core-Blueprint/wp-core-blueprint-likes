...
final class Targets {
	...
	public static function select_placeholder( bool $include_users = true ): string {
		return $include_users
			? __( 'Select content or user', 'core-blueprint-likes' )
			: __( 'Select content', 'core-blueprint-likes' );
	}
